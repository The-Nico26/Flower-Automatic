...
bool ESP8266::sendSingleHttp(const char* url)
{
  rx_empty();
  m_puart->print("AT+CIPSEND=");
...
int ESP8266::http(String host, String url){
    String request =  "GET "+url+" HTTP/1.1\r\nHost: "+host+"\r\nUser-Agent: ESP8266-WiFi/1.0\r\nConnection: close\r\n\r\n";
    
    if (createTCP(host, 80))
      {
     ...
     if (!sendSingleHttp(request.c_str()))
      {
